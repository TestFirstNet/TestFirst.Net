...
namespace TestFirst.Net.Test
{
    ...
    public class MatchDiagnosticsTest
    {
        ...
        {
            Assert.AreEqual(expect.Trim(), actual, "Not equal, actual '{}', got '{}'", actual, expect);
        }

        private class MyMatcher : AbstractMatcher<string>
        {
        ...
        private class MyNestedMatcher<T> : AbstractMatcher<T>
        {
