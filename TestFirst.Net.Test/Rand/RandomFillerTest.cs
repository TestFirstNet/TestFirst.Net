...
namespace TestFirst.Net.Test.Rand
{
    ...
    public class RandomFillerTest
    {
        ...
        private class MyStringDto
        {
            public string MyString { get; set; }
        }

        private class MyNestedStringDto
        {
        ...
        private class MyGuidDto
        {
            public Guid? MyGuid { get; set; }
        }

        private class MyEnumDto
        {
            public enum MyEnum
            {
                One, Two, Three
        ...
        private class MyListDto
        {
            public IList<string> MyList { get; set; }
        }

        private class MyConcreteListDto
        {
            public List<string> MyList { get; set; }
        }

        private class MyDictDto
        {
            public IDictionary<string, double?> MyDict { get; set; }
        }

        private class MyConcreteDictDto
        {
            public Dictionary<string, double?> MyDict { get; set; }
        }

        private class MyDateTimeDto
        {
            public DateTime? MyDateTime { get; set; }
        }

        private class MyTimeSpanDto
        {
            public TimeSpan? MyTimeSpan { get; set; }
        }

        private class MyArrayDto
        {
