...
namespace TestFirst.Net.Test.Matcher
{
    ...
    public class PropertyMatcherTest : BaseMatcherTest
    {
        ...
        public void CanMatchOnSuperClassPropertyTest()
        {
            AssertPasses(
                new Employee("Bob"),
                AnEmployeeNotSubHumanMatcher.With().Name("Bob"));
        ...
        private static PropertyMatcher<FooPoco> ExpectFoo()
        {
            return new PropertyMatcher<FooPoco>();
        }
        ...
        internal class AnEmployeeNotSubHumanMatcher : PropertyMatcher<Employee>
        {
            private static readonly Employee PropertyNames = null;

            public static AnEmployeeNotSubHumanMatcher With()
            {
                return new AnEmployeeNotSubHumanMatcher();
            }

            public AnEmployeeNotSubHumanMatcher Name(string name)
            {
                WithProperty(() => PropertyNames.Name, AString.EqualTo(name));
                return this;
            }
