...
namespace TestFirst.Net.Performance
{
    public class PerformanceMetric
    {
        ...
        /// <summary>
        /// Gets or sets the additional data to be logged. string can contain anything. In the case of errors it is 
        ...
        public class PerformanceTimer
        {
            ...
            /// <summary>
            /// Return a timing metric for the given action. If the action throws an exception the metric returned will be flagged
            /// as an error metric
            /// </summary>
            /// <param name="action">The action to collect metrics for</param>
